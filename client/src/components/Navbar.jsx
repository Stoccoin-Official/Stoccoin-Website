...
export default function Example() {
  ...
  //Create state to keep track of the toggle whether it is checked or not 
  //NB: True is light and false is dark mode 
  const [isChecked, setIsChecked] = useState(false)


  
//Function to handle the check status and update the state and also change the color settings of the webiste
