      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 className="mb-5 text-4xl md:text-8xl xl:text-4xl text-center font-bold font-heading tracking-px-n leading-none">
            {t("Pricing that Fits Your Trading Strategy")}
          </h2>
          <h5 className="mb-5 text-center tracking-px-n leading-none">
            {t("Take Your Trading to the Next Level with Our Plans")}
          </h5>
        </div>
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-white rounded-lg border border-gray-100 dark:border-gray-600 xl:p-8 hover:shadow-2xl hover:scale-105">
            ...
            <p className="font-light sm:text-lg">
              {t("Get a taste of trading with our free plan.")}
            </p>
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
                ...
                <span>
                  {t("Premium support")}: <span className="font-semibold">6 {t("months")}</span>
                </span>
              </li>
              <li className="flex items-center space-x-3">
                {/* Icon */}
                ...
                <span>
                  {t("Free updates")}: <span className="font-semibold">6 {t("months")}</span>
                </span>
              </li>
              <li className="flex items-center space-x-3">
                {/* Icon */}
          ...
          {/* Pricing Card */}
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-white rounded-lg border border-gray-100 dark:border-gray-600 xl:p-8 hover:shadow-2xl hover:scale-105">
            <h3 className="mb-4 text-2xl font-semibold">{t("Professional")}</h3>
            <p className="font-light sm:text-lg">
              {t("Unlock advanced trading features with our premium plan.")}
            </p>
            <div className="flex justify-center items-baseline my-8">
          ...
          {/* Pricing Card */}
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-white rounded-lg border border-gray-100 dark:border-gray-600 xl:p-8 hover:shadow-2xl hover:scale-105">
            <h3 className="mb-4 text-2xl font-semibold">{t("Enterprise")}</h3>
            <p className="font-light sm:text-lg">
              {t("Custom solutions for your trading needs.")}
            </p>
            <div className="flex justify-center items-baseline my-8">
